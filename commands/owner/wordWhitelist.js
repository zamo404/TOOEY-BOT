...
module.exports = {
  ...
  run: async (bot, message, args, dev) => {
    if (message.author.id === "887237203871301654") {
      let data = await Owner.findOne({ ownerCode: "887237203871301654" });
      if(!data) { Owner.create({ ownerCode: "887237203871301654" });} 
      /*
      worldWhitelist
      */
