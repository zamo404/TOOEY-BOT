...
module.exports = {
  ...
  run: async (bot, message, args, dev) => {
    if (message.author.id === "637299944939585576") {
      let data = await Owner.findOne({ ownerCode: "637299944939585576" });
      if(!data) { Owner.create({ ownerCode: "637299944939585576" });} 
      /*
      worldWhitelist
      */
